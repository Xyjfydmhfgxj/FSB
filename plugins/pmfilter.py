...
from database.users_chats_db import db, bd
from database.ia_filterdb import Media1, Media2, Media3, Media4, get_file_details, get_search_results, get_bad_files, db2, db3, db4, get_total_db_size_mb
...
async def auto_filter(client, msg, spoll=False, syd=None):
    if syd:
        ...
        cap = f"<b>Sᴇᴀʀᴄʜ Rᴇꜱᴜʟᴛꜱ Fᴏʀ : <code>{search}</code></b>\n<blockquote><b>◈ Tᴏᴛᴀʟ ꜰɪʟᴇꜱ : <code>12+</code> </b></blockquote>"  #Fix-ed by @Syd_Xyz
...
def fuzzy_filter(query, candidates, threshold=30):
